...
/*{oldDescription}   Working from you solution to the exercise
above, add the color white to PaintColors.scala. In the match
expression, return the "other" color whenever white is blended with
it. Satisfy the following tests:
{oldDescription}*/
