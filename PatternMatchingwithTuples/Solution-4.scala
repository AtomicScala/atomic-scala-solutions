...
/*{oldDescription}
 Working from your solution to Exercise 2, add another color (magenta) to PaintColors.scala and verify that the rest of the examples still work correctly. Satisfy the following tests:
